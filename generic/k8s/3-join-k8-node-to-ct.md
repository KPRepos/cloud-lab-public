...
kubeadm join 10.0.0.223:6443 --token h5bqd5xxxxxx --discovery-token-ca-cert-hash sha256:38c7a44d9d81ebe70xxxxxxxxxxxx

# if token expired, get new token and ca cert uinsg belwo commands 
# kubeadm token create
# openssl x509 -pubkey -in /etc/kubernetes/pki/ca.crt | openssl rsa -pubin -outform der 2>/dev/null | openssl dgst -sha256 -hex | sed 's/^.* //'

kubeadm join ControlPlane-IP:6443 --token 99ivet.0vykxxxxxx --discovery-token-ca-cert-hash sha256:38c7a4xxxxxxx
