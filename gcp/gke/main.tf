...
module "gke" {
  ...
  preemptible_spot_primary           = var.preemptible_spot_primary
  deploy_secondary_node_pool         = var.deploy_secondary_node_pool
  secondary_node_pool_min_node_count = var.secondary_node_pool_min_node_count
  secondary_node_pool_machine_type   = var.secondary_node_pool_machine_type
  secondary_node_pool_max_node_count = var.secondary_node_pool_max_node_count
  preemptible_spot_secondary         = var.preemptible_spot_secondary
